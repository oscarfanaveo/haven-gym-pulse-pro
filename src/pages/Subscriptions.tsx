...
const plans = [
  { name: "Basic", price: 135, description: "3 times a week access" },
  { name: "Regular", price: 160, description: "Full time access to gym and machines" },
  { name: "Premium", price: 200, description: "Full access plus complementary classes" },
  { name: "Temporary", price: "Variable", description: "Special events and classes" }
];
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                ...
                <p className="text-xs text-green-500">Currently subscribed</p>
              </div>
        ...
        <Card className="haven-card">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <p className="text-sm text-white/60">Expired Subscriptions</p>
                <p className="text-2xl font-bold">{expiredSubscriptions}</p>
                <p className="text-xs text-yellow-500">Need renewal</p>
              </div>
        ...
        <Card className="haven-card">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <p className="text-sm text-white/60">Next Renewals</p>
                <p className="text-2xl font-bold">5</p>
                <p className="text-xs text-blue-500">Due this week</p>
              </div>
      ...
      <Tabs defaultValue="members" className="w-full">
        <TabsList className="bg-haven-dark grid grid-cols-2 w-full max-w-md">
          <TabsTrigger value="members" className="data-[state=active]:bg-haven-red">Members</TabsTrigger>
          <TabsTrigger value="plans" className="data-[state=active]:bg-haven-red">Subscription Plans</TabsTrigger>
        </TabsList>
