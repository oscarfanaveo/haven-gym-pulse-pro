...
const ProductSalesPlaceholder = () => {
  return (
    <div className="text-center text-white/60">
      ...
      <p className="text-xl font-medium mb-2 text-white">Historial de Ventas</p>
      <p className="text-white/60">Visualiza el historial y rendimiento de ventas de productos</p>
